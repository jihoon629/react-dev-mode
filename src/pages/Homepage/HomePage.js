...
const HomePage = () => {
  const navigate = useNavigate();
    ...
    const testimonials = [
    {
      ...
      quote: "아버지가 남기신 말 한 마디, 우리 가족 모두가 함께 들을 수 있었어요. 마침표 덕분에 아버지의 마지막 뜻을 명확히 알 수 있었습니다."
    },
    {
      name: "이지현",
      job: "50대 자영업자",
      image: "/images/ei.PNG",
      quote: "복잡한 상속 문제로 가족 간 갈등이 있었는데, 마침표를 통해 작성한 유언장 덕분에 모든 것이 명확해졌어요. 이제 마음의 평화를 찾았습니다."
    },
    {
      name: "박준호",
      job: "30대 IT 전문가",
      image: "/images/back.PNG",
      quote: "기술에 익숙하지 않은 부모님을 위해 마침표를 소개해드렸어요. 너무 쉬운 인터페이스에 부모님도 직접 사용하실 수 있었고, 이제 가족 모두 안심하고 있습니다."
    }
  ];
